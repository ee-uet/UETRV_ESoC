...
module instr_mem (input [11:0] A, input clk, io_wr_en, rst,output [31:0] RD);
   ...
   xpm_memory_spram #(
      ...
      .MEMORY_INIT_FILE("main.mem"),     // String
   ...
   xpm_memory_spram_inst (
      ...
      .wea(io_wr_en)                        // WRITE_DATA_WIDTH_A-bit input: Write enable vector for port A input
