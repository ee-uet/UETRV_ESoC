...
enum opt_code
{
  ...
  OPT_mbranch_cost_ = 1598,                  /* -mbranch-cost= */
  OPT_mcmodel_ = 1599,                       /* -mcmodel= */
  OPT_mdiv = 1600,                           /* -mdiv */
  OPT_mexplicit_relocs = 1601,               /* -mexplicit-relocs */
  OPT_mfdiv = 1602,                          /* -mfdiv */
  OPT_mplt = 1603,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 1604,     /* -mpreferred-stack-boundary= */
  OPT_mrelax = 1605,                         /* -mrelax */
  OPT_mriscv_attribute = 1606,               /* -mriscv-attribute */
  OPT_mrvv_vector_bits_ = 1607,              /* -mrvv-vector-bits= */
